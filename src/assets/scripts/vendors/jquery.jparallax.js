    ...
    return this.each(function () {
      ...
      if (settings.mouseResponse) {
        jQuery().mousemove(function (mouse) {
          // Is mouse inside?
          mouseport.xinside =
            mouse.pageX >= mouseport.left && mouse.pageX < mouseport.width + mouseport.left ? true : false;
          mouseport.yinside =
            mouse.pageY >= mouseport.top && mouse.pageY < mouseport.height + mouseport.top ? true : false;
